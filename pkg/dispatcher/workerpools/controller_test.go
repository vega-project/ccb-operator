			...
			workerpools: []ctrlruntimeclient.Object{
				&workersv1.WorkerPool{
					...
					Spec: workersv1.WorkerPoolSpec{
						Workers: map[string]workersv1.Worker{
							"worker-1": {Name: "worker-1", State: workersv1.WorkerAvailableState, LastUpdateTime: &metav1.Time{Time: time.Date(2022, 1, 1, 12, 0, 0, 0, time.UTC)}},
							"worker-2": {Name: "worker-2", State: workersv1.WorkerAvailableState, LastUpdateTime: &metav1.Time{Time: time.Date(2022, 1, 1, 11, 0, 0, 0, time.UTC)}},
							"worker-3": {Name: "worker-3", State: workersv1.WorkerAvailableState, LastUpdateTime: &metav1.Time{Time: time.Date(2022, 1, 1, 10, 0, 0, 0, time.UTC)}},
						},
					},
				},
			},
